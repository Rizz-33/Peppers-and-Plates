...
const placeOrder = async (req,res) => {
    ...
    try {
        ...
        console.log(error);
        res.json({success:false,message:"Error in Process!"})
    }
}
...
const verifyOrder = async (req,res) => {
    ...
    try {
        if (success==="true") {
            ...
            res.json({success:false,message:"Payment is not successful!"})
        }
    } catch (error) {
        console.log(error);
...
const userOrders = async (req,res) => {
    try {
        ...
        console.log(error);
        res.json({success:false,message:"Uncaught Error. Please try again!"})
    }
}
...
const updateStatus = async (req, res) => {
    try {
        ...
        console.log(error);
        res.json({success:false,message:"Error updating the status. Please try again!"})
    }
}
